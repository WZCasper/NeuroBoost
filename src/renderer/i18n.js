...
const LOCALES = {
  ru: {
    ...
    'ui.subtitle': 'Оптимизатор системы',
    'ui.systemStatus': 'Статус системы',
    'ui.debloatTitle': 'Пакеты Windows AppX',
    'ui.removeSelected': 'Удалить выбранное',
    'ui.progress': 'Ход выполнения',
    'ui.telemetryTitle': 'Конфиденциальность и телеметрия',
    'ui.apply': 'Применить',
    'ui.ramTitle': 'Оптимизатор ОЗУ',
    'ui.used': 'Занято',
    'ui.freed': 'Освобождено',
    'ui.processesCleaned': 'Процессов очищено',
    'ui.liveCleaning': 'Очистка в реальном времени',
    'ui.runningProcesses': 'Запущенные процессы',
    'ui.autoBoost': 'Авто-ускорение',
    'ui.startupTitle': 'Программы в автозагрузке',
    'ui.diskTitle': 'Очистка диска',
    'ui.cleanSelected': 'Очистить выбранное',
    'ui.settingsTitle': 'Настройки',
    'ui.startWithWindows': 'Запускать с Windows',
    'ui.minimizeToTray': 'Сворачивать в трей при закрытии',
    'ui.support': 'Диагностика и поддержка',
    'ui.openLogs': 'Открыть папку с журналом',
    'ui.startUsing': 'Начать работу',
    'disk.firefox_cache': 'Кэш браузера Firefox',
    'restorePoint.throttled': 'Точка восстановления уже создавалась сегодня — она защищает эти изменения',
    'restorePoint.disabled': 'Защита системы отключена в Windows — точка восстановления НЕ создана',
    'restorePoint.error': 'Не удалось создать точку восстановления — изменения применены без неё',
    'process.killedGraceful': 'Процесс {name}.exe закрыт корректно',
    'process.killedForced': 'Процесс {name}.exe завершён принудительно',
  ...
  en: {
    ...
    'ui.subtitle': 'System optimizer',
    'ui.systemStatus': 'System status',
    'ui.debloatTitle': 'Windows AppX packages',
    'ui.removeSelected': 'Remove selected',
    'ui.progress': 'Progress',
    'ui.telemetryTitle': 'Privacy & telemetry',
    'ui.apply': 'Apply',
    'ui.ramTitle': 'RAM optimizer',
    'ui.used': 'Used',
    'ui.freed': 'Freed',
    'ui.processesCleaned': 'Processes cleaned',
    'ui.liveCleaning': 'Live cleaning',
    'ui.runningProcesses': 'Running processes',
    'ui.autoBoost': 'Auto-Boost',
    'ui.startupTitle': 'Startup programs',
    'ui.diskTitle': 'Disk cleanup',
    'ui.cleanSelected': 'Clean selected',
    'ui.settingsTitle': 'Settings',
    'ui.startWithWindows': 'Start with Windows',
    'ui.minimizeToTray': 'Minimize to tray on close',
    'ui.support': 'Diagnostics & support',
    'ui.openLogs': 'Open log folder',
    'ui.startUsing': 'Get started',
    'disk.firefox_cache': 'Firefox browser cache',
    'restorePoint.throttled': 'A restore point already exists from today - it covers these changes',
    'restorePoint.disabled': 'System Protection is turned off in Windows - NO restore point was created',
    'restorePoint.error': 'Could not create a restore point - changes were applied without one',
    'process.killedGraceful': 'Process {name}.exe closed cleanly',
    'process.killedForced': 'Process {name}.exe was force-terminated',
